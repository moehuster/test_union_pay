    ...
    def DataType(self, field, DataType=None):
        if DataType == None:
            ...
            if DataType not in DT:
                raise SpecError("Cannot set data type '{0}' for F{1}: Invalid data type"
    ...
    def ContentType(self, field, ContentType=None):
        if ContentType == None:
            ...
            if ContentType not in self.__ValidContentTypes:
                raise SpecError("Cannot set Content type '{0}' for F{1}: Invalid content type"
    ...
    def LengthType(self, field, LengthType=None):
        if LengthType == None:
            ...
            if LengthType not in self.__ValidContentTypes:
                raise SpecError("Cannot set Length type '{0}' for F{1}: Invalid length type"
                                .format(LengthType, field))
...
class IsoSpec1987ASCII(IsoSpec1987):
    def SetDataTypes(self):
        ...
        self.DataType('TPDU', DT.ASCII)
        self.DataType('HEADER', DT.ASCII)
...
class IsoSpec1987BCD(IsoSpec1987):
    def SetDataTypes(self):
        ...
        self.DataType('TPDU', DT.BCD)
        self.DataType('HEADER', DT.BCD)
...
ContentTypes['1987'] = {
    ...
    48:  {'ContentType': 'ans', 'MaxLen': 600, 'LenType': LT.LLLVAR},
    ...
    60:  {'ContentType': 'n',   'MaxLen': 100, 'LenType': LT.LLLVAR},
